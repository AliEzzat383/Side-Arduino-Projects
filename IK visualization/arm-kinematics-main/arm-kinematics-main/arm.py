...
class arm:
    ...
    def move(self,filename):
        ...
        #        self.theta3=self.theta3-math.copysign(180,self.theta3)
           ...
           self.theta2=abs(round(self.theta2,0))
           self.theta3=abs(round(self.theta3,0))
        #    print(self.theta1,self.theta2,self.theta3)
           
           self.str = f'0,{self.theta1},{-self.theta2+90},0,{((self.theta3%90)+90)},60'.encode()
           print(self.str)
