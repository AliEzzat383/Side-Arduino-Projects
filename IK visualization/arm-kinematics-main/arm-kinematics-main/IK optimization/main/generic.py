...
class arm:
    def __init__(self, a0, a1, a2, a3):
        ...
        #joint variables
        self.theta0, self.theta1, self.theta2, self.wrist, self.theta3 = 0, 0, 0, 0, 0
    ...
    def inverse_kinematics_N4(self, x_t, y_t, z_t, boundaries=None):
    ...
    def draw(self):
        ...
        text_x = self.font.render(f"x: {self.target_point[0]}", True, self.colors['black'])
                ...
                if self.active:
                    if event.key == pygame.K_RETURN:
                        ...
                        try:
                            ...
                            boundaries = [(-np.radians(180), 0), (0, np.radians(145)), (-np.radians(90), np.radians(90))]
                            pos = [self.end_reach, self.end_y, self.end_height] # here for easy editing
                            if self.end_reach == 0:
                                self.destination = [(pos[1] + self.Cx), (self.a0 + self.Cy - pos[2])]
                            elif self.end_y == 0:
    ...
    def writefile(self,filename,var_list):
