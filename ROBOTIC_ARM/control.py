...
while running:
    ...
    if value1 != previous_value1 or value2 != previous_value2 or value3 != previous_value3 or value4 != previous_value4:
    ...
    if keys[pygame.K_UP]:
        ...
        value4 += step
        if value4 > 30:
            value4 = 30  # Limit value4 to a maximum of 30
    elif keys[pygame.K_RIGHT]:
        time.sleep(delay / 1000.0)  # Delay in seconds
        value4 -= step
        if value4 < 10:
            value4 = 10  # Ensure value4 doesn't go below 20
